...
conf.addEvent(event1);
conf.addEvent(event2);
event1.registerSpeaker(speaker1);
event1.registerAttendee(attendee1);
event2.registerSpeaker(speaker2);
event2.registerAttendee(attendee2);
System.out.println("Events by Dr. Jane Doe: " +
conf.getEventsBySpeaker("S101").size());
System.out.println("Events by Dr. Mike Lee: " +
conf.getEventsBySpeaker("S102").size());
    }
}
