...
public static void main(String[] args) {
    ...
    while (done) {
        ...
        else if (count == 2 && player2.isAlive()) {
        ...
        else if (count == 3 && numberOfPlayers>= 3&& player3.isAlive()) {
        ...
        else if (count == 4 && numberOfPlayers >= 4&& player4.isAlive()) {
        ...
        else if (count == 1 && !player1.isAlive()) {
            count++;
        }
        else if (count == 2 && !player2.isAlive()) {
            count++;
        }
        else if (count == 3 && !player3.isAlive()) {
            count++;
        }
        else if (count == 4 && !player4.isAlive()) {
            count++;
        }
